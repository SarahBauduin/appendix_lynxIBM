...
defineModule(sim, list(
  ...
  parameters = rbind(
    ...
    defineParameter("pMortDispAlps", "numeric", 0.004, NA, NA, "Fixed daily probability of mortality for dispersers in the Alps"),
    defineParameter("pMortDispJura", "numeric", 0.004, NA, NA, "Fixed daily probability of mortality for dispersers in the Jura"),
    defineParameter("pMortDispVosgesPalatinate", "numeric", 0.004, NA, NA, "Fixed daily probability of mortality for dispersers in the Vosges-Palatinate"),
    defineParameter("pMortDispBlackForest", "numeric", 0.004, NA, NA, "Fixed daily probability of mortality for dispersers in the Black Forest"),
    defineParameter("corrFactorRes", "numeric", 15, NA, NA, "Correction factor for road mortality risk for residents"),
    defineParameter("corrFactorDisp", "numeric", 5, NA, NA, "Correction factor for road mortality risk for dispersers"),
