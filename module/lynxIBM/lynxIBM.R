...
defineModule(sim, list(
  ...
  parameters = rbind(
    ...
    defineParameter("pMortDispAlps", "numeric", 0.0035, NA, NA, "Fixed daily probability of mortality for dispersers in the Alps"),
    defineParameter("pMortDispJura", "numeric", 0.0035, NA, NA, "Fixed daily probability of mortality for dispersers in the Jura"),
    defineParameter("pMortDispVosgesPalatinate", "numeric", 0.0035, NA, NA, "Fixed daily probability of mortality for dispersers in the Vosges-Palatinate"),
    defineParameter("pMortDispBlackForest", "numeric", 0.0035, NA, NA, "Fixed daily probability of mortality for dispersers in the Black Forest"),
